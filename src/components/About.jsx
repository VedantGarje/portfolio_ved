  ...
  return (
    <article className={`about ${isActive ? 'active' : ''}`} data-page="about">
      ...
      <section className="about-text">
        <p>
          Hello! I’m a passionate UI/UX Designer and Web Developer currently pursuing Information Technology at Bharati Vidyapeeth College of Engineering, Navi Mumbai, Maharashtra.
        </p>

        <p>
          I may not have professional experience in a company yet, but I’ve worked on several personal and academic projects that reflect my growing skills and creativity.
        </p>
      </section>
        ...
        <ul className="service-list">
          <li className="service-item">
            <div className="service-icon-box">
              <img src="src/assets/images/icon-design.svg" alt="design icon" width="40" />
            </div>
